                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="text" class="form-control" name="username_user" id="username_user" placeholder="Ingrese su usuario">
                        ...
                        <p class="text-center mb-0">Don't have an Account? <a href="<?php echo site_url(); ?>/seguridades/formularioRegistro">Sign Up</a></p>
</form>
