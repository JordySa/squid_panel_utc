        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"><?php echo
              $this->session->userdata("c0nectadoUTC")->username_user; ?></h6>
                        <span><?php echo
              $this->session->userdata("c0nectadoUTC")->role_user; ?></span>
                    </div>
                </div>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex"><?php echo
              $this->session->userdata("c0nectadoUTC")->username_user; ?></span>
                        </a>
